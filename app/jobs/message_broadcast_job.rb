...
class MessageBroadcastJob < ApplicationJob
  ...
  def perform(comment)
    ...
    ActionCable.server.broadcast "room_channel", comment: render_message(comment), content: comment.content, long_content:comment.long_content, title: comment.title, room_id: comment.room_id, sender_id:comment.sender_id, receiver_id:comment.receiver_id, created_at:tmp, emotion:comment.emotion, expression:comment.expression
